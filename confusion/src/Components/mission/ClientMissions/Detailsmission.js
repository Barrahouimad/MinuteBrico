        ...
        <div id="detailsMissions">
           ...
           <div  className="Container mt-3">
               ...
               <div style={{marginLeft:"250px"}} className="row justify-content-start mt-3">
                    <div style={{background:"#D1653E",textColor:"white",padding:"5px",marginTop:"20px"}} className="col-md-6 col-xs-10">
                            <h1>Récapitulatif de vos missions</h1>
                    </div>
                    
               </div>
               <div className="container">
                   <CarteBrico missionId={document.location.pathname.split("/")[2]}/>
               </div>
           </div>
        </div>);
