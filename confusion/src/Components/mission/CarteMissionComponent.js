              ...
              <div className="card-img ">
                    <div id="carouselExampleSlidesOnly"  className="carousel slide " data-bs-ride="carousel">
                        <div className="carousel-inner " >
                                ...
                                <img id="missionImage" style={{height:"200px",width:"850px", borderRadius:"5px"}} src={item.image}/>
                                </div>
                                <div className="carousel-item">
                                <img style={{height:"200px",width:"850px", borderRadius:"5px"}} src={item.image}/>
                                </div>
                                <div className="carousel-item">
                                <img style={{height:"200px",width:"850px", borderRadius:"5px"}} src={item.image}/>
                                </div>
                        ...
                        <div className="card-img-overlay">
                            <div className="d-flex flex-column" style={{border:"1px  #91091E",opacity: "0.5",width:"350px" , height:"150px",background:"gray"}}>
                                 ...
                                 <p className="card-text" style={{fontFamily:"'Lato', sans-serif",marginRight:"120px"}}>{item.description}</p>
