      ...
      <div  id="mission">
       ...
       <div className="container mt-5" >
         <div id="head" className="row">
            ...
            <div className="col-6"> 
              <a  href="/home" className="py-2 navbar-link"> <img className="Brand " src="assets/logo.png" style={{height:"150px",width:"150px",position:"relative",bottom:"60px"}} /></a>   
            </div> 
           ...
           <div className="row">
          <div id="box" className="col-md-10 mt-5 mx-5"style={{ borderRadius:"62px",width:"850px",height:"450px",backgroundColor:"rgba(1,0,0,0)",paddingRight:"2px" ,zIndex:"0"}} > 
         ...
         <div className="col-md-auto mt-5 mx-3" style={{paddingTop:"80px"}}>
               <div className="form-check">
                 <input className="form-check-input"  onClick={()=>radioHandlerTout()} type="radio" name="tout" checked/>
