...
class Form2 extends Component {
    ...
    continue = e => {
        ...
        if( name_certification!==0  && name_centre!==0 && date_obtention!==0  && date_expiration!==0  &&  categorySelected!==0){
            const certif=[{
    ...
    render() {
        const { values,setCategorie } = this.props;
        return (
            <div className="form-container mt-5 mb-5 " style={{width:"50%"}}>
                    ...
                    <div style={{marginLeft:"50px", marginRight:"50px"}}>
                        <form>
                            ...
                            <DropDownListCheckBox  setCategorie={this.setCategoriee}  />
