            ...
            <div className="form-container mt-5 mb-5 " style={{width:"50%"}}>
                ...
                <div style={{marginLeft:"50px", marginRight:"50px"}}>
                    <form>
                        ...
                        <h3 className="Certificat mb-3 mt-5 ml-4 mr-4" style={{color:"#D1653E",fontSize:"20px",backgroundColor:"white",textAlign:"center"}}>Certificat</h3>

                        <div className=" mb-4 md-5 mt-4" >
                            <label style={{float:"left"}} className="form-label" htmlFor="form5Example1">Nom du certificat<span style={{color:'red'}}>*</span> </label>
                        ...
                        <div className=" mb-4 md-5 mt-4">
                            <label style={{float:"left"}} className="form-label" htmlFor="form5Example1">Centre de délivrance<span style={{color:'red'}}>*</span> </label>
                        ...
                        <div className="form-outline mb-4 mt-5">
                            <label style={{float:"left"}} className="form-label" for="customFile">Scan du certificat<span style={{color:'red'}}>*</span></label>
