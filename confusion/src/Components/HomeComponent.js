  ...
  const inscrire=(isBrico,keysignup,toggles)=>{
    if(isBrico){
      return(
        ...
        <ModalHeader >Inscrivez vous
        <button className="btn btn-danger" style={{position:"absolute",right:"8px"}} onClick={toggles} >X</button>
        </ModalHeader>
        <ModalBody>
            <Form>
            <div class="mb-3 row">
...
return(
    ...
    <div>
       <div className="fluid-container"  >
           <div className="navbar  row justify-content-between" style={{boxShadow: "0px 1px 16px  #c5d7bd" }} >
            ...
            <a  href="/home" className="navbar-link"> <img className="col-md-3" src="assets/Brand.jpeg" style={{height:"40px",width:"110px"}}/></a>
                ...
                <BiSearchAlt id="Searchvv" style={{marginTop:"5px",fontSize:"30"}} />
                <input className="form-control  ms-2" id="Search" type="search" onChange={(event)=>handlSetSearch(event)} placeholder="trouver des problèmes similaires">
       ...
       <div>
           ...
           <div className="col-md-6 mt-5">  
                        <img src='assets/careerb.png' style={{width:"550px",height:"550px",boxShadow:"0px 4px 12px #c5d7bd" , borderRadius:"100px"}}/>   
                </div>
                <div  className="col-md-6" style={{marginTop:"60px",fontFamily:"'Roboto Mono', monospace"}} >  
                 <section id="text"  className="d-flex flex-column">
          ...
          {inscrire(isBrico,keysignup,toggles)}
            ...
            <Modal isOpen={keyconnection} toggle={toggles}>
              <ModalHeader >Conectez Vous !
              <button className="btn btn-danger" style={{position:"absolute",right:"8px"}} onClick={togglec} >X</button></ModalHeader>
              <ModalBody>
                  <Form>
                  <div class="mb-3 row">
